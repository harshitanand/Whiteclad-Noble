...
router
  ...
  .put(validateBody(userSchemas.update), UserController.updateProfile);
...
router
  .route('/:userId')
  .get(validateParams({ userId: commonSchemas.id }), UserController.getUser)
  .put(
  ...
  .delete(validateParams({ userId: commonSchemas.id }), UserController.deleteUser);
